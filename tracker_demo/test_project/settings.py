...
ADMINS = (
    # ('Your Name', 'your_email@tracker_demo.com'),
)
...
# Example: "/var/www/tracker_demo.com/media/"
...
# Example: "/var/www/tracker_demo.com/static/"
STATIC_ROOT = ''
...
STATICFILES_DIRS = (
    ...
    os.path.normpath(os.path.join(SITE_PATH, 'static')),
)
...
SECRET_KEY = '$!6tj%wfdhfd43534h7751up=6%o_z$)k85d$s(vqt9kk21d4)'
...
ROOT_URLCONF = 'tracker_demo.test_project.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'tracker_demo.test_project.wsgi.application'
...
# For allauth package: http://django-allauth.readthedocs.org/en/latest/#requirements
ACCOUNT_AUTHENTICATION_METHOD = "username_email"

# See: http://django-allauth.readthedocs.org/en/latest/#requirements
